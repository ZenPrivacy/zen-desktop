...
export function FilterListsScreen({ filterLists }: FilterListsScreen) {
  ...
  return (
    <div className="intro-screen">
      <h3 className="bp5-heading intro-heading">{t('introOverlay.filterLists.title')}</h3>
      <p className="bp5-running-text intro-description">
        <Trans
          i18nKey="introOverlay.filterLists.description"
          components={{
            strong: <strong />,
          }}
        />
      </p>
      <p className="bp5-running-text intro-description">{t('introOverlay.filterLists.recommendation')}</p>
